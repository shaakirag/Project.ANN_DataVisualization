...
instructions_btn = tk.Button(frame, textvariable=instructions_txt, command=lambda: instructions(font), font=font,
...
browse_btn = tk.Button(frame, textvariable=browse_txt,
                       command=lambda: open_file(root, frame, menubar, filemenu, editmenu, browse_txt, False, font), font=font,
