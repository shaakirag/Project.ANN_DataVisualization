...
def comparative_analysis(main_notebook, labels, font, df):
    ...
    tk.Button(frame1, text='Correlation Table', command=lambda: correlation_table(main_notebook, df, font), font=font, bg='#008080',
              fg='White').place(relx=0.25, rely=0.1, relwidth=0.5, relheight=0.05)
    tk.Button(frame1, text='Covariance Table', command=lambda: covariance_table(main_notebook, df, font), font=font, bg='#008080',
              fg='White').place(relx=0.25, rely=0.2, relwidth=0.5, relheight=0.05)
    ...
    tk.Button(frame1, text='Violin Plot', command=lambda: violin_plot(main_notebook, df, font), font=font,
              bg='#008080', fg='White').place(relx=0.25, rely=0.4, relwidth=0.5, relheight=0.05)
    tk.Button(frame1, text='2D Histogram', command=lambda: twoD_histogram(main_notebook, df, font), font=font,
              bg='#008080', fg='White').place(relx=0.25, rely=0.5, relwidth=0.5, relheight=0.05)
    tk.Button(frame1, text='Contour Plot', command=lambda: contour_plot(main_notebook, df, font), font=font,
              bg='#008080', fg='White').place(relx=0.25, rely=0.6, relwidth=0.5, relheight=0.05)
    tk.Button(frame1, text='KDE Plot', command=lambda: kde_plot(main_notebook, df, font), font=font,
              bg='#008080', fg='White').place(relx=0.25, rely=0.7, relwidth=0.5, relheight=0.05)
    tk.Button(frame1, text='Scatter Plot', command=lambda: scatter_plot(main_notebook, df, font, labels), font=font,
              bg='#008080', fg='White').place(relx=0.25, rely=0.8, relwidth=0.5, relheight=0.05)
